...
CREATE TABLE
    houses(
        ...
        imgUrl VARCHAR(255) NOT NULL DEFAULT 'https://images.unsplash.com/photo-1511919884226-fd3cad34687c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
        description VARCHAR(255) NOT NULL DEFAULT 'This Is A House You Can Buy!',
        price INT NOT NULL,
        createdAt DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT 'Time Created',
        updatedAt DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Last Update'
    ) default charset utf8mb4 COMMENT 'supports emojis';
...
VALUES (
        ...
        2,
        24000,
        'This House Will Set You Back For The Forseable Future!'
    );
